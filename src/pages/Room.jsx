...
export default function Room() {
  ...
  // Auto-switch to auction tab when auction goes active
  useEffect(() => {
    if (auction.isActive) {
  ...
  // If player hasn't joined yet, show join prompt
  if (!currentPlayer) {
    return (
      <div
        style={{
  ...
  return (
    ...
    >
      <MarqueeHeader
        ...
        subtitle={
          activeTab === 'auction' ? '★ AUCTION NIGHT ★' : 'Room: ' + room.code
        }
      />
          ...
          <button
            ...
            style={{
              background:
                activeTab === tab.id
                  ? tab.highlight
                    ? 'linear-gradient(180deg, #2d0a0a, #1a1410)'
...
// ─── Join Prompt (when browser has no player in this room) ──
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
            ...
            <div>
              ...
              <input
                ...
                placeholder="e.g. Wild Card Pictures"
                style={inputStyle}
                onFocus={(e) => (e.target.style.borderColor = '#c9a227')}
                onBlur={(e) => (e.target.style.borderColor = '#3a3025')}
              />
            ...
            {error && (
              <div
                style={{ color: '#e63946', fontSize: 13, textAlign: 'center' }}
              >
                {error}
              </div>
            )}
